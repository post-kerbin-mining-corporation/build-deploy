...
from ksp_deploy.helpers import get_build_data, get_version_file_info, get_changelog
...
def deploy_curseforge(ksp_version, mod_id, changelog, zipfile):
    ...
    curse_token = get_ssm_value("ksp-curseforge-token")
...
def deploy_spacedock(version, ksp_version, mod_id, changelog, zipfile):
    ...
    spacedock_user = get_ssm_value("ksp-spacedock-login")
    spacedock_pw = get_ssm_value("ksp-spacedock-password")
